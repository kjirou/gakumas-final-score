...
const siteSummary =
  "学園アイドルマスターの最終試験で、SS/S+/Sランクのために必要なスコアを計算するツール";
    ...
    <Layout>
      <main className={styles.page}>
        ...
        <ul>
          ...
          <li>
            評価点によりランクが決まる。SS:16,000以上、S+:14,500以上、S:13,000以上、A+:11,500以上、A:10,000以上、B+:8,000以上、B:6,000以上、C+:4,500以上、C:3,000以上、D:3,000以下。
          </li>
          <li>
            本計算式は、
